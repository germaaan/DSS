...
import com.mio.xml.jaxb.modelo.Libro;
import com.mio.xml.jaxb.modelo.Libreria;
...
public class LibroPrincipal {
	...
	public static void main(String[] args) throws JAXBException, IOException {
		...
		// conseguir las variables de nuestro archivo XML, que hemos creado
		// anteriormente
		System.out.println();
		System.out.println("Salida desde nuestro archivo XML: ");
		Unmarshaller um = contexto.createUnmarshaller();
		Libreria libreria2 = (Libreria) um.unmarshal(new FileReader(
				LIBRERIA_XML));
